 ...
 */
@Provider
public class ErrorResultExceptionMapper implements ExceptionMapper<ErrorResultException> {

    @Override
    public Response toResponse(ErrorResultException exception) {
        if (exception instanceof EntryNotFoundException) {
            EntryNotFoundException notFoundEx = (EntryNotFoundException) exception;
